...
public class reservevehicledetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reservevehicledetails);
        ...
        bts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(reservevehicledetails.this,
        ...
        bts2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                String usss=bundle.getString("user");
                ...
                if(ry==0)
                {
                    ...
                    String endt=sd2.getText().toString();
                    ...
                    Reservation res=new Reservation(duedt,endt);
                    ...
                    Toast toast=Toast.makeText(getApplicationContext()," Vehicle Reservation Sucessfully",Toast.LENGTH_SHORT);
                    toast.setMargin(25,25);
                    toast.show();
                }
                else
                {
                    Toast toast=Toast.makeText(getApplicationContext(),"Someone Already Reserved",Toast.LENGTH_SHORT);
                    toast.setMargin(25,25);
                    toast.show();
                }
