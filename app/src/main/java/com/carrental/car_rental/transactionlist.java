...
public class transactionlist extends AppCompatActivity {
    ...
    transactioncustvechileadpater vehadpt;
    String bookdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(javacollections.Transaction chku:addvehcile.returncarrentdetails) {
        ...
        vehadpt= new transactioncustvechileadpater(this,vehcilesList,urwr);
