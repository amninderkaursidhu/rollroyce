...
public class avcustvechileadpater extends RecyclerView.Adapter<avcustvechileadpater.vehicleviewholder> {

    Context mctx;
    String persndt;

    public avcustvechileadpater(Context mctx, List<vehcileinformation> vehcilesList, String personaldata) {
        this.mctx = mctx;
    ...
    public vehicleviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(mctx).inflate(R.layout.availbalecustvehcileviewlistlayout,viewGroup,false);
