...
public class return_managecustvechileadpater extends RecyclerView.Adapter<return_managecustvechileadpater.vehicleviewholder> {

    Context mctx;
    String persndt;

    public return_managecustvechileadpater(Context mctx, List<vehcileinformation> vehcilesList, String personaldata) {
        this.mctx = mctx;
    ...
    public vehicleviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(mctx).inflate(R.layout.return_reservation_layout,viewGroup,false);
       ...
       vehicleviewholder.imageView.setImageResource(resourceId);
        ...
        vehicleviewholder.delts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mctx.startActivity(new Intent(mctx,submitreservation.class).putExtra("type",ty).putExtra("model",md).putExtra("plate",plt).putExtra("color",col).putExtra("brand",brnd).putExtra("Year",yer).putExtra("pstn",pp).putExtra("imgs",imagename).putExtra("user",username));
