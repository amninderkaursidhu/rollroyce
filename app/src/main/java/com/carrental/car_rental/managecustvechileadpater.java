...
public class managecustvechileadpater extends RecyclerView.Adapter<managecustvechileadpater.vehicleviewholder> {

    Context mctx;
    String persndt;

    public managecustvechileadpater(Context mctx, List<vehcileinformation> vehcilesList, String personaldata) {
        this.mctx = mctx;
    ...
    public vehicleviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(mctx).inflate(R.layout.cancel_reservation_layout,viewGroup,false);
       ...
       vehicleviewholder.imageView.setImageResource(resourceId);
        ...
        vehicleviewholder.delts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mctx.startActivity(new Intent(mctx, remove_Reservation.class).putExtra("type",ty).putExtra("model",md).putExtra("plate",plt).putExtra("color",col).putExtra("brand",brnd).putExtra("Year",yer).putExtra("pstn",pp).putExtra("imgs",imagename).putExtra("user",username));
