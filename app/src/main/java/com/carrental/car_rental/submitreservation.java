...
public class submitreservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submitreservation);
        bts=(Button)findViewById(R.id.btn_date);
        bts2=(Button)findViewById(R.id.subnow);
        ...
        bts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(submitreservation.this,
        ...
        bts2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vehicleobjectstore addvehcile=vehicleobjectstore.getInstance();
                    ...
                    Rental rnss=new Rental(duedt,duedt);
                    Return retdt=new Return(duedt);
                    ...
                    trobj.returncarrentdetails.add(k);
                    trobj.carrentdetails.remove(pstions);
                    System.out.println("Your Due Date is "+duedt);
                    Toast toast=Toast.makeText(getApplicationContext()," Vehicle Return Sucessfully",Toast.LENGTH_SHORT);
