...
public class twomanagecustvechileadpater extends RecyclerView.Adapter<twomanagecustvechileadpater.vehicleviewholder> {

    Context mctx;
    String persndt;

    public twomanagecustvechileadpater(Context mctx, List<vehcileinformation> vehcilesList, String personaldata) {
        this.mctx = mctx;
    ...
    public vehicleviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(mctx).inflate(R.layout.cancel_reservation_layouttwo,viewGroup,false);
       ...
       vehicleviewholder.imageView.setImageResource(resourceId);
        ...
        vehicleviewholder.delts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mctx.startActivity(new Intent(mctx,remove_Reservationtwo.class).putExtra("type",ty).putExtra("model",md).putExtra("plate",plt).putExtra("color",col).putExtra("brand",brnd).putExtra("Year",yer).putExtra("pstn",pp).putExtra("imgs",imagename).putExtra("user",username));
